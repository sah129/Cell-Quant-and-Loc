...
```{r}
res <- pipeline_git1("Datasets/Figure 1B/Unanalyzed", testing=FALSE, gui=FALSE, progress=NULL, sigma = .3, offset= 0.002, cutoff = 50)
```
...
```{r}
t<-paintObjects(m, tgt = channel(r$channels$gfp, "asgreen"), col = c('red','red'))
tt<-paintObjects(v, tgt = t, col = "blue")
display(tt)
```
