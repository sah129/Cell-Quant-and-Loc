...
source('src/Main.R')
datasetpath <- "Datasets/2020-07-14 Ato2"
```
...
groups = list("9ArrD Ato2 A", "9ArrD Ato2 C", "BY4741 Ato2 A", "BY4741 Ato2 B", "Idb19D Ato2 A", "Idb19D Ato2 B")
sort_data(res, groups, "2020-07-14 Ato2")
```
