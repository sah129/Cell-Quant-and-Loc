...
source('src/Main.R')
datasetpath <- "Datasets/Pmtovacratioquants/2020-07-23 Ste3"
```
...
```{r}
start <- Sys.time()
res <- pipeline(datasetpath, testing=FALSE, gui=FALSE, progress=NULL, interactive = FALSE, 4, dic_channel, 1000)
end = Sys.time()
...
name = "2020-07-23 Ste3"
groups = list("9ArrD Ste3 A", "9ArrD Ste3 B", "aly1Daly2D Ste3 A", "aly1Daly2D Ste3 B",   "BY4742 Ste3 A", "BY4742 Ste3 B", "ldb19D Ste3 A", "ldb19D Ste3 B")
