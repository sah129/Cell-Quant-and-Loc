...
datasetpath <- "Datasets/Pmtovacratioquants/2020-07-14 Ato2"
```
...
channels <- read_in_channels(imageset[5,], datasetpath) #006
img_gray <- convert_to_grayscale(channels)
membranes <- detect_membranes_new(img_gray, channels,4, img_gray[,,dic_channel],1000)
